  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <div className="page-subtitle">{itemLabel} &bull; {allLeaves ? 'Papers & Documentation' : 'Click to view details &bull; Scroll to zoom'}</div>
      </div>
      ...
      {allLeaves ? (
        <div className="papers-list">
          {children.map((paper) => (
            <div className="paper-card" key={paper.id}>
              ...
              {paper.url && (
                <a href={paper.url} target="_blank" rel="noopener noreferrer" className="paper-open-btn-sm">
                  Open ↗
                </a>
              )}
            </div>
        ...
        <div className="graph-area">
          <RadialDendrogram data={subCategory} onNodeClick={handleNodeClick} />
        </div>
      )}
    </div>
  );
